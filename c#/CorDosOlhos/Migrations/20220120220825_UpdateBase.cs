        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SobrenomeC = table.Column<string>(type: "varchar(50)", nullable: false),
                    ...
                    CidadeC = table.Column<string>(type: "varchar(50)", nullable: true),
                    UFC = table.Column<string>(type: "char(2)", nullable: true),
                    CEPC = table.Column<string>(type: "char(8)", nullable: true),
                    BairroC = table.Column<string>(type: "varchar(50)", nullable: true),
                    EnderecoC = table.Column<string>(type: "varchar(50)", nullable: true),
                    NumeroC = table.Column<string>(type: "char(7)", nullable: false),
                    TelefoneC = table.Column<string>(type: "char(13)", nullable: false),
                    EmailC = table.Column<string>(type: "varchar(50)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailContato = table.Column<string>(type: "varchar(50)", nullable: false),
                    MsgContato = table.Column<string>(type: "varchar(MAX)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BairroRegistro = table.Column<string>(type: "varchar(50)", nullable: true),
                    EnderecoRegistro = table.Column<string>(type: "varchar(50)", nullable: false),
                    NumeroRegistro = table.Column<string>(type: "char(7)", nullable: true),
                    PontoRefRegistro = table.Column<string>(type: "varchar(50)", nullable: true),
                    DescricaoRegistro = table.Column<string>(type: "varchar(MAX)", nullable: true)
                },
                constraints: table =>
                {
